...
<section>
  <div class="max-w-screen-md px-4 mx-auto">
      ...
      <form name="contact" action="https://formsubmit.co/philemon@labtracka.com" method="POST" class="space-y-6">
          <div class="my-4">
          ...
          <div class="my-4">
              <label for="subject" class="block mb-2 font-medium text-gray-900 text-md dark:text-gray-300"><strong>Your Name (Lab/Individual/Company Name):</strong></label>
           ...
           <div class="my-4">
              <label for="subject" class="block mb-2 font-medium text-gray-900 text-md dark:text-gray-300"><strong>How much are you willing to pay for LabTracka (Medical Laboratories Only):</strong></label>
